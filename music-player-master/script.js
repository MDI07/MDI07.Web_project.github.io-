var isDrawerOpen = false,
  ...
  dawerProgress,
  isKorean = false,
  baseUrl = "https://MirzajonovD.github.io/music-player/",
  accentColorAr = [
    "#ff4b66",
    "#62ff6e",
    "#ffb762",
...
var korean = [
  {
    ...
    singer: "Artik Asti",
    duration: "2:54",
    url: "songs/rus/Artik_Asti_-_Garmoniya.mp3",
    albumArt: "images/Rus/artik-asti.jpg",
  },
...
function generateElements(ko) {
  ...
  if (ko) {
    songs = korean;
    $(".left-pannel__anime").text("_Russian");
    $(".left-pannel__anime").css("color", currentProfile.accentColor);
    ...
    $(".left-pannel__favorite").css("color", currentProfile.accentColor);
    $(".left-pannel__anime").text("Russian");
